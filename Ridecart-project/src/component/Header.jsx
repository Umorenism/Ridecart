    ...
    <header className="fixed top-0 p-5 left-0 w-full z-50 bg-[#F4F4F4]  px-4">
          ...
          <div className="relative">
            ...
            {showDropdown && (
              ...
              border shadow-lg rounded-[8px] py-2 w-48 z-50">
                <a href="#" className="block px-4 py-2 text-sm hover:text-black hover:bg-gray-100">Web Development</a>
                <a href="#" className="block px-4 py-2 text-sm hover:text-black hover:bg-gray-100">Mobile Apps</a>
                <a href="#" className="block px-4 py-2 text-sm hover:text-black hover:bg-gray-100">SEO Services</a>
              </div>
            )}
          </div>
      ...
      >
        <ul className="space-y-4">
          ...
          <li>
            <a href="#" className="bg-[#EB203E] mr-10 text-white px-6 py-2  rounded-full font-bold inline-block" onClick={toggleDrawer}>
              Contact Us
            </a>
          </li>
        </ul>
